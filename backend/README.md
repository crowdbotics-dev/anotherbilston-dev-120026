...
## Project Structure
    ...
    ├── anotherbilston_dev_120026  # Django project configurations
...
1. Clone this repo and `cd anotherbilston_dev_120026`
...
2. Clone this repo and `cd anotherbilston_dev_120026`
